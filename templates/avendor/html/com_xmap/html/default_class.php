...
class XmapHtmlDisplayer extends XmapDisplayer {
    ...
    */
    function printNode( &$node )
    {
        ...
        $out .= '<li><i class="fa fa-angle-right fa-li"></i>';
    ...
    */
    function changeLevel( $level ) {
        if ( $level > 0 ) {
            ...
            $this->_openList = "\n<ul class=\"list-default list-divider biglist divider-list fa-ul level_".$this->level."\">\n";
            $this->_closeItem = '';
            ...
            if ($this->_childs[$this->level]){
                echo $this->_closeItem."</ul><div class=\"clearfix\"></div>\n";
            }
            $this->_closeItem ='</li>';
            $this->_openList = '';
            $this->level += $level;
