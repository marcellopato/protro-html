	...
	var Mosaic = new Class({
		...
		loadMore: function(event, container, page){
			...
			var ajax = container.retrieve('roksprocket:mosaic:ajax'),
				filterby = container.getElement('[data-mosaic-filterby].btn-primary'),
				params = {
		...
		filterBy: function(event, container, element){
			container.getElements('[data-mosaic-filterby]').removeClass('btn-primary');
		...
		orderBy: function(event, container, element){
			...
			container.getElements('[data-mosaic-orderby]').removeClass('btn-primary');
			if (orderBy != 'random') element.addClass('btn-primary');
		},
